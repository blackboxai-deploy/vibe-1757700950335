...
const BookReaderApp: React.FC = () => {
  ...
  // Admin State
  const [adminView, setAdminView] = useState<'books' | 'users' | 'analytics' | 'settings'>('books');
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <div className={`${getThemeClasses()} p-4 rounded-lg mb-4`}>
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      <div className={`${getThemeClasses()} px-4 py-6 shadow-lg`}>
        ...
        <div className="flex gap-2 overflow-x-auto">
          {(['books', 'users', 'analytics', 'settings'] as const).map((view) => (
            <Button
              key={view}
